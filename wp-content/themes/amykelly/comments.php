...
<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		<h3 id="comments-title"><?php printf( _n( '%1$s Comment', '%1$s Comments', get_comments_number(), 'coraline' ), number_format_i18n( get_comments_number() ), '<span>' . get_the_title() . '</span>' ); ?></h3>
	...
	<div id="sarah-comment-form"><?php comment_form(); ?></div>
